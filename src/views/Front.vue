      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        ...
        <ul class="d-flex">
          <li class="nav-item position-relative">
            <router-link class="nav-link text-white" aria-current="page" to="/cart"><svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor" class="bi bi-cart-fill" viewBox="0 0 16 16">
...
.front-bg{
  ...
  height: 100vh;
  background:
  linear-gradient(to right, rgba(3, 3, 3, 0.8), rgba(2, 2, 2, 0.8)),
